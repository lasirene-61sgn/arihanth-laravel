...
$tableContent = <<<'HTML'
                        ...
                        <tbody>
                            ...
                            @empty
                            <tr>
                                <td colspan="13" class="tw-text-center tw-py-4 tw-text-gray-500 dark:tw-text-gray-400">{{ __('messages.no_data_found') }}</td>
                            </tr>
HTML;

$search = '/<th class="tw-text-center tw-text-\[14px\] tw-font-bold tw-text-orange-500">OVERDUE\(C\/W\)<\/th>\s*@endforelse/s';
$content = preg_replace($search, $tableContent, $content);

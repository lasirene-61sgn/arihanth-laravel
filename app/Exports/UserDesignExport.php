...
class UserDesignExport implements FromQuery, WithHeadings, WithMapping
{
    protected $request;
    ...
    public function map($d): array {
        return [$d->design_code, $d->product_code, $d->product_name, $d->category->name ?? 'N/A', $d->subcategory->name ?? 'N/A', $d->type, $d->weight_from, $d->weight_to];
    }
}
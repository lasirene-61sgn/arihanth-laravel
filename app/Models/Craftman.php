...
class Craftman extends Authenticatable
{
    ...
    {
        return [
            'allocated_tab_wo_accept', 'allocated_tab_wo_bulk_accept', 'allocated_tab_wo_reject', 'allocated_tab_wo_bulk_reject', 'allocated_tab_wo_view',
            'in_process_tab_wo_complete', 'in_process_tab_wo_bulk_complete', 'in_process_tab_wo_view',
            'overdue_tab_wo_accept', 'overdue_tab_wo_bulk_accept', 'overdue_tab_wo_reject', 'overdue_tab_wo_bulk_reject', 'overdue_tab_wo_complete', 'overdue_tab_wo_bulk_complete', 'overdue_tab_wo_view',
            'for_approval_tab_wo_view', 'completed_tab_wo_view', 'rejected_tab_wo_view', 'all_orders_tab_wo_view',
        ];
    }

...
class WorkOrderController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Removed for approval orders since key users don't need this tab
        ...
        return view('key-user.work-order.index', compact(
    ...
    private function loadWorkOrdersAjax(Request $request)
    {
        ...
        return response()->json([
            'html' => view('key-user.work-order.partials.orders-table', compact('workOrders'))->render(),
    ...
    public function create()
    {
        ...
        return view('key-user.work-order.create', compact('buyers', 'categories'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $workOrder = WorkOrder::create([
            ...
            'creator_type' => 'key_user',
            'creator_user_code' => $keyUser ? $keyUser->user_code : null,
        ]);
        ...
        return redirect()->route('key-user.work-order.index', ['tab' => 'new-orders'])
    ...
    {
        $workOrder->load(['productCategory', 'subcategoryRelation', 'buyer', 'craftsman', 'product.images']);
    ...
    {
        return view('key-user.work-order.print', compact('workOrder'));
    }
    ...
    public function edit(WorkOrder $workOrder)
    {
        ...
        return view('key-user.work-order.edit', compact('workOrder', 'categories', 'buyers', 'products'));
    }
    ...
    public function update(Request $request, WorkOrder $workOrder)
    {
        ...
        return redirect()->route('key-user.work-order.index')->with('success', 'Work Order updated successfully!');
    }

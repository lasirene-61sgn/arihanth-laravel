...
class CraftsmanStaffController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.business-partner.craftsman-staff.index', compact('staffs', 'craftsmen'));
    }
    ...
    public function create()
    {
        ...
        if (!$admin || !$admin->hasPermission('can_create_staff')) {
            return redirect()->route('admin.business-partner.craftsman-staff')->with('error', 'You do not have permission to create Craftsman Staff.');
        }

        $craftsmen = Craftman::all();
        return view('admin.business-partner.craftsman-staff.create', compact('craftsmen'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.business-partner.craftsman-staff')
    ...
    {
        return view('admin.business-partner.craftsman-staff.show', compact('staff'));
    }
    ...
    public function edit(CraftsmanStaff $staff)
    {
        $admin = Auth::guard('admin')->user();
        if (!$admin || !$admin->hasPermission('can_create_staff')) {
            return redirect()->route('admin.business-partner.craftsman-staff')->with('error', 'You do not have permission to edit Craftsman Staff.');
        }

        $craftsmen = Craftman::all();
        return view('admin.business-partner.craftsman-staff.edit', compact('staff', 'craftsmen'));
    }
    ...
    public function destroy(CraftsmanStaff $staff)
    {
        $admin = Auth::guard('admin')->user();
        if (!$admin || !$admin->hasPermission('can_create_staff')) {
            return redirect()->route('admin.business-partner.craftsman-staff')->with('error', 'You do not have permission to delete Craftsman Staff.');
        }
    ...
    public function printSelected(Request $request)
    {
        ...
        return view('admin.business-partner.craftsman-staff.print-selected', compact('staffs'));
    }
}
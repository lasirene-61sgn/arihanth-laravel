...
class CraftsmanProductionController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.craftsman-production.index', compact('craftsmen', 'search', 'perPage'));
    }
    ...
    public function show(Request $request, $code)
    {
        ...
        // 1. Fetch Work Orders & Purchase Orders
        ...
        // 5. LengthAware Pagination for Work Orders and Purchase Orders
        ...
        return view('admin.craftsman-production.show', compact(
            'craftsman',
            'workOrders',
            'purchaseOrders',
            'tab',

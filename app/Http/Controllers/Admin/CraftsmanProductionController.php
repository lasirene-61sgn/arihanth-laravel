...
class CraftsmanProductionController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.craftsman-production.index', compact('craftsmen'));
    }
    ...
    public function show(Request $request, $code)
    {
        ...
        return view('admin.craftsman-production.show', compact('craftsman', 'workOrders', 'purchaseOrders', 'tab', 'buyers', 'buyerCode', 'buyerMetrics'));
    }
}

...
use App\Exports\AdminKeyUserExport;
...
class KeyUserController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.key-user.index', compact('keyUsers'));
    }
    ...
    {
        $buyers = Buyer::all();
        return view('admin.key-user.create', compact('buyers'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.key-user.index')
    ...
    {
        return view('admin.key-user.show', compact('keyUser'));
    }
    ...
    {
        $buyers = Buyer::all();
        return view('admin.key-user.edit', compact('keyUser', 'buyers'));
    }
    ...
    {
        return Excel::download(new AdminKeyUserExport($request), 'AdminKeyUserExport_' . now()->format('d-m-Y') . '.xlsx');
    }
    ...
    public function printSelected(Request $request)
    {
        ...
        return view('admin.key-user.print-selected', compact('keyUsers'));
    }
}

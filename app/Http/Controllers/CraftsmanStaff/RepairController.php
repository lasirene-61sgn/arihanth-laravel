...
class RepairController extends Controller
{
    public function index()
    {
        ...
        $repairs = Repair::with('buyer')
            ...
            ->latest()
            ->paginate(10);
        return view('craftsman_staff.repairs.index', compact('repairs'));
    }
    ...
    public function show($id)
    {
        ...
        return view('craftsman_staff.repairs.show', compact('repair'));
    }
    ...
    public function accept($id)
    {
        ...
        return redirect()->route('craftsman_staff.repairs.index')->with('success', 'Repair accepted.');
    }
    ...
    public function reject($id)
    {
        ...
        return redirect()->route('craftsman_staff.repairs.index')->with('success', 'Repair rejected.');
    }
    ...
    public function complete($id)
    {
        ...
        $repair->update($updateData);
        return redirect()->route('craftsman_staff.repairs.index')->with('success', 'Repair marked as completed by craftsman.');
    }
}

...
class ProductController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('craftsman.product.index', compact('products', 'categories', 'subcategories'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('craftsman.product.index')->with('success', 'Product created successfully!');
        } catch (\Exception $e) {
    ...
    public function edit(Product $product)
    {
        ...
        $product->load('images');
        return view('craftsman.product.edit', compact('product', 'categories', 'subcategories'));
    }
    ...
    public function update(Request $request, Product $product)
    {
        ...
        try {
            ...
            return redirect()->route('craftsman.product.index')->with('success', 'Product updated!');
        } catch (\Exception $e) {
    ...
    public function destroy(Product $product)
    {
        ...
        $product->delete();
        return redirect()->route('craftsman.product.index')->with('success', 'Deleted!');
    }

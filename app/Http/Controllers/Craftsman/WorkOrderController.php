...
class WorkOrderController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('craftsman.work-order.index', compact(
            'allocatedOrders', 
            'inProcessOrders', 
            'completedOrders', 
            'rejectedOrders',
    ...
    public function printSelected(Request $request)
    {
        ...
        return view('craftsman.work-order.print-selected', compact('workOrders'));
    }
    ...
    public function show(WorkOrder $workOrder)
    {
        ...
        return view('craftsman.work-order.show', compact('workOrder'));
    }
    ...
    public function print(WorkOrder $workOrder)
    {
        ...
        return view('craftsman.work-order.print', compact('workOrder'));
    }
    ...
    public function bulkReject(Request $request)
    {
        ...
        return redirect()->route('craftsman.work-order.index', ['tab' => 'rejected'])
    ...
    public function reject(WorkOrder $workOrder)
    {
        ...
        return redirect()->route('craftsman.work-order.index')

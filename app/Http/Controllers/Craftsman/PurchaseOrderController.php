...
class PurchaseOrderController extends Controller
{
    ...
    public function bulkAccept(Request $request)
    {
        ...
        return redirect()->route('craftsman.purchase-order.index', ['tab' => 'in-process'])
    ...
    public function bulkReject(Request $request)
    {
        ...
        return redirect()->route('craftsman.purchase-order.index', ['tab' => 'rejected'])
    ...
    public function printSelected(Request $request)
    {
        ...
        return view('craftsman.purchase-order.print-selected', compact('ordersWithDetails', 'company'));
    }
    ...
    public function show(PurchaseOrder $purchaseOrder)
    {
        ...
        if ($purchaseOrder->allocated_craftsman_code !== $craftsman->craftman_code) {
            return redirect()->route('craftsman.purchase-order.index')
        ...
        return view('craftsman.purchase-order.show', compact('purchaseOrder', 'itemsWithDetails', 'rejectedItemsWithDetails'));
    }
    ...
    public function print(PurchaseOrder $purchaseOrder)
    {
        ...
        return view('craftsman.purchase-order.print', compact('purchaseOrder', 'itemsWithDetails'));
    }
    ...
    public function processItems(Request $request, PurchaseOrder $purchaseOrder)
{
    ...
    public function completeItems(Request $request, PurchaseOrder $purchaseOrder)
    {
        ...
        if (empty($remainingItems)) {
            ...
            return redirect()->route('craftsman.purchase-order.show', $purchaseOrder)

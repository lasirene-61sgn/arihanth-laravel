...
class FavoriteController extends Controller
{
    ...
    public function edit($user_id, $user_type)
    {
        ...
        return view('super-admin.favorites.edit', compact('favorites', 'user', 'user_type', 'products'));
    }
    ...
    public function update(Request $request, $user_id, $user_type)
    {
        ...
        return redirect()->route('super-admin.favorites.index')->with('success', 'Favorites successfully updated.');
    }

...
class UserController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->get('export') === 'excel') {
            return Excel::download(new UserExport($request), 'users-list.xlsx');
        }
        ...
        // Using pagination (10 users per page)
    ...
    public function create()
    {
        ...
        return view('super-admin.user.create', compact('buyers'));
    }
    ...
    {
        $buyers = \App\Models\Buyer::all();
        return view('super-admin.user.edit', compact('user', 'buyers'));
    }
    ...
    public function printSelected(Request $request)
    {
        ...
        return view('super-admin.user.print-selected', compact('users'));
    }
}

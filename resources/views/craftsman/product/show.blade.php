            ...
            <div class="page-title-box d-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{ route('craftsman.dashboard') }}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('craftsman.product.index') }}">Products</a></li>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a href="{{ route('craftsman.product.edit', $product) }}" class="btn btn-primary btn-sm me-2">
                            <i class="bi bi-pencil"></i> Edit
                        </a>
                        <form action="{{ route('craftsman.product.destroy', $product) }}" method="POST" class="d-inline" 

...
<div class="container-fluid">
    <div class="card">
        ...
        <div class="card-body">
            ...
            @endif
            <form action="{{ route('craftsman.product.update', $product) }}" method="POST" enctype="multipart/form-data">
                @csrf @method('PUT')
                <div class="row">
                ...
                <div class="text-end">
                    <a href="{{ route('craftsman.product.index') }}" class="btn btn-light">Back</a>

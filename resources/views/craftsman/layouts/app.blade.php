...
<head>
    ...
    <style type="text/tailwindcss">
        ...
        html.dark .text-emerald-900, html.dark .text-emerald-800, html.dark .text-emerald-700 { color: #f3f4f6 !important; }
        html.dark .bg-emerald-50 { background-color: #374151 !important; }
        html.dark .bg-emerald-100 { background-color: #4b5563 !important; color: #f3f4f6 !important; }
        html.dark .border-emerald-200, html.dark .border-emerald-100 { border-color: #374151 !important; }
...
<body class="bg-emerald-50 text-emerald-950 font-sans">
    ...
    <div class="modal fade" id="pdfPreviewModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content rounded-xl border-none shadow-2xl">
                <div class="modal-header border-emerald-100">
                    <h5 class="modal-title font-bold text-emerald-900">Design Preview</h5>

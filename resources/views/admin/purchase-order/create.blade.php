        ...
        <div class="col-12">
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('admin.purchase-order.store') }}" enctype="multipart/form-data" id="purchaseOrderForm">
                        @csrf
                                    ...
                                    <table class="table table-bordered align-middle" id="itemsTable">
                                        ...
                                        <tbody id="itemsContainer">
                                            <tr class="item-row">
                                                <td class="sno">1</td>
                                                <td>
                                                    <select class="form-select category-select select2" name="items[0][category]" required>
                        ...
                        <div class="d-flex justify-content-between border-top pt-3">
                            <a href="{{ route('admin.purchase-order.index') }}" class="btn btn-secondary px-4">Cancel</a>
            ...
            fetch("{{ route('admin.purchase-order.get-products-by-category') }}?category_id=" + categoryId)
                ...
                .then(data => {
                    ...
                    data.forEach(product => {
                        ...
                        opt.textContent = ` ${product.product_name}${designText}`;

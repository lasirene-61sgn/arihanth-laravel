        ...
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('admin.purchase-order.allocate.store', $purchaseOrder) }}">
                        @csrf
                                            ...
                                            <tbody>
                                                @foreach($itemsWithDetails as $index => $item)
                                                    <tr>
                                                        ...
                                                        <td>{{ $item['category_name'] ?? ($item['category']->name ?? ($item['category'] ?? 'N/A')) }}</td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <span class="badge bg-secondary">
                                                                {{ isset($item['product']) ? ($item['product']->design_code ?? 'N/A') : ($item['design_code'] ?? 'N/A') }}
                                                            </span>
                                                        </td>
                                                        <td>

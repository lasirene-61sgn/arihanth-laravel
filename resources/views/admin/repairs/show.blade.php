...
<style>
    ...
    /* Modern Timeline Styling for History Log */
    .timeline-container {
        position: relative;
        padding-left: 1.5rem;
    }
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
        <div>
            <div class="d-flex align-items-center gap-2 mb-1">
                <a href="{{ route('admin.repairs.index') }}" class="text-decoration-none text-muted small fw-medium">
        ...
        <div class="d-flex gap-2">
            <a href="{{ route('admin.repairs.index') }}" class="btn btn-white btn-sm border shadow-sm px-3 fw-medium">
                <i class="bi bi-arrow-left me-1"></i> Back
            </a>
            @if(in_array($repair->status, ['Pending', 'Accepted']))
            <a href="{{ route('admin.repairs.edit', $repair->id) }}" class="btn btn-primary btn-sm shadow-sm px-3 fw-medium">
                ...
                <div class="card-body p-4 text-center">
                    ...
                    @else
                        <div class="py-5 text-muted bg-light rounded-3 border-dashed">
                            ...
                            <span class="small fw-medium">No image proof attached</span>
                        </div>
                    @endif
                </div>
            </div>

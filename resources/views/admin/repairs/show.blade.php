        ...
        <div class="col-12">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                ...
                <div class="btn-toolbar mb-2 mb-md-0">
                    <a href="{{ route('admin.repairs.index') }}" class="btn btn-sm btn-secondary me-2">
                        <i class="bi bi-arrow-left"></i> Back to List
                    </a>
                    @if(in_array($repair->status, ['Pending', 'Accepted']))
                    <a href="{{ route('admin.repairs.edit', $repair->id) }}" class="btn btn-sm btn-primary">
            ...
            <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="card mb-4 shadow-sm border-0 h-100">
                                ...
                                <div class="card-body pt-0">
                                    @if($repair->buyer)
                                    <div class="row mb-2">
                                        <div class="col-5 text-muted small">BP Code</div>
                                        <div class="col-7">{{ $repair->buyer->bp_code }}</div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col-5 text-muted small">Name</div>
                                        <div class="col-7 font-weight-bold">{{ $repair->buyer->customer_name }}</div>
                                    </div>
                                    @else
                ...
                <div class="col-md-4">
                    ...
                    <div class="card mb-4 shadow-sm border-0">
                        ...
                        <div class="card-body text-center pt-0">
                            ...
                            <a href="{{ asset($repair->image_proof) }}" target="_blank">
                                <img src="{{ asset($repair->image_proof) }}" class="img-fluid rounded border shadow-sm" alt="Repair Proof" style="max-height: 400px; object-fit: contain;">
                            </a>
                            <div class="mt-3">
                            ...
                            <div class="py-5 text-muted bg-light rounded">
                                <i class="bi bi-image text-3xl d-block mb-3 opacity-25"></i>
                    ...
                    <!-- Danger Zone -->
                    <div class="card border-danger shadow-sm border-1">
                        <div class="card-header bg-danger text-white border-0">
                            <h5 class="card-title mb-0">Danger Zone</h5>
                        </div>
                        <div class="card-body p-3">
                            <p class="small text-muted mb-3">Deleting a repair order is permanent and cannot be undone.</p>
                            <form action="{{ route('admin.repairs.destroy', $repair->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this repair order? This action cannot be undone.');">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-danger btn-block w-100 font-weight-bold">

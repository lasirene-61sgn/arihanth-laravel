    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0">Create Key User</h4>
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('admin.key-user.index') }}">Key Users</a></li>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Key User Details</h4>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                    ...
                    <form action="{{ route('admin.key-user.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="aadhar_number" 
                                           name="aadhar_number" 
                                           value="{{ old('aadhar_number') }}" maxlength="12" 
           minlength="12">
                                    @error('aadhar_number')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="card border border-info">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            @foreach(\App\Models\KeyUser::getGroupedApiPermissions() as $tabName => $permissions)
                                                <div class="col-12 mt-2"><strong class="text-primary">{{ $tabName }}</strong></div>
                                                @foreach($permissions as $permission)
                                                    <div class="col-md-6 mb-2">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" name="permissions[]" value="{{ $permission }}" id="permission_{{ $permission }}" {{ in_array($permission, old('permissions', \App\Models\KeyUser::getDefaultApiPermissions())) ? 'checked' : '' }}>
                                                            <label class="form-check-label" for="permission_{{ $permission }}">
                        ...
                        <div class="d-flex justify-content-end mt-4">
                            <a href="{{ route('admin.key-user.index') }}" class="btn btn-secondary me-2">Cancel</a>
                            <button type="submit" class="btn btn-primary">Create Key User</button>
                        </div>
                    </form>
                </div>
            </div>

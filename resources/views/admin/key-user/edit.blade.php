        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.key-user.update', $keyUser) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                                            ...
                                            @foreach(\App\Models\KeyUser::getWebPermissions() as $permission)
                                                <div class="col-md-6 mb-3">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="permissions[]" value="{{ $permission }}" id="permission_{{ $permission }}" {{ in_array($permission, old('permissions', $keyUser->getPermissionsArray())) ? 'checked' : '' }}>

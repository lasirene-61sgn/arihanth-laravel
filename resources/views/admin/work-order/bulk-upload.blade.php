        ...
        <div class="col-12">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                ...
                <div class="btn-toolbar mb-2 mb-md-0">
                    <a href="{{ route('admin.work-order.index') }}" class="btn btn-sm btn-outline-secondary">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.work-order.import-order-list') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">

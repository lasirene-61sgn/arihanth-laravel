    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.work-order.store') }}" method="POST" enctype="multipart/form-data" id="workOrderForm">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3 category-option" data-opt="has_hook" style="display:none;">
                                <label for="has_hook" class="form-label">Hook</label>
                                <select class="form-select" id="has_hook" name="has_hook">
                                    <option value="">Select Status</option>
                                    <option value="Single" {{ old('has_hook') == 'Single' ? 'selected' : '' }}>Single</option>
                                    <option value="Double" {{ old('has_hook') == 'Double' ? 'selected' : '' }}>Double</option>
                                </select>
                            </div>

                            <div class="col-md-6 mb-3 category-option" data-opt="has_enamel" style="display:none;">
                                <label for="has_enamel" class="form-label">Enamel</label>
                                <select class="form-select" id="has_enamel" name="has_enamel">
                                    <option value="">Select Status</option>
                                    <option value="Yes" {{ old('has_enamel') == 'Yes' ? 'selected' : '' }}>Yes</option>
                                    <option value="No" {{ old('has_enamel') == 'No' ? 'selected' : '' }}>No</option>
                                </select>
                            </div>

                            <div class="col-md-6 mb-3 category-option" data-opt="has_rodium" style="display:none;">
                                <label for="has_rodium" class="form-label">Rodium</label>
                                <select class="form-select" id="has_rodium" name="has_rodium">
                                    <option value="">Select Status</option>
                                    <option value="Yes" {{ old('has_rodium') == 'Yes' ? 'selected' : '' }}>Yes</option>
                                    <option value="No" {{ old('has_rodium') == 'No' ? 'selected' : '' }}>No</option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-6 mb-3 category-option" data-opt="has_stone" style="display:none;">
                                ...
                                <select class="form-select" id="has_stone" name="has_stone">
                                    <option value="">Select Status</option>
                                    <option value="Yes" {{ old('has_stone') == 'Yes' ? 'selected' : '' }}>Yes</option>
                                    <option value="No" {{ old('has_stone') == 'No' ? 'selected' : '' }}>No</option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="weight_from" name="weight_from" value="{{ old('weight_from') }}" required>
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="weight_to" class="form-label">Weight To *</label>
                                <input type="text" class="form-control" id="weight_to" name="weight_to" value="{{ old('weight_to') }}" required>
                            </div>
                            <div class="col-md-4 mb-3">
                            ...
                            <!-- <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="hallmark" name="hallmark" value="{{ old('hallmark') }}">
                            </div> -->
                            <div class="col-md-4 mb-3">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea class="form-control" id="narration_craftsman" name="narration_craftsman" rows="2">{{ old('narration_craftsman') }}</textarea>
                            </div>
                            <div class="col-md-12 mb-3">
                                <label for="narration_admin" class="form-label">Narration (Admin)</label>
                                <textarea class="form-control" id="narration_admin" name="narration_admin" rows="2">{{ old('narration_admin') }}</textarea>
                            </div>
                        </div>
...
<script>
    $(document).ready(function() {
        ...
        function toggleCategoryOptions(categoryId) {
            ...
            return fetch(`/admin/product/get-category-options?category_id=${categoryId}`)
        ...
        function performLookup(code) {
            ...
            fetch(`/admin/work-order/get-product-details?product_code=${encodeURIComponent(code)}`)
                .then(response => response.ok ? response.json() : { success: false })
                .then(data => {
                    if (data.success) {
                        const fields = ['product_name', 'design_code', 'hallmark', 'rodium', 'hook', 'size', 'stone', 'enamel', 'length', 'weight_from', 'weight_to', 'relabel_code'];
                        fields.forEach(f => {
                        ...
                        if (data.product.product_image_url && designImagePreview && noImageText) {
                            ...
                            designImagePreview.style.display = '';

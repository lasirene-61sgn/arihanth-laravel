...
<div>
    ...
    <div class="card">
        <form action="{{ route('admin.favorites.store') }}" method="POST" id="favoritesForm">
            @csrf
            ...
            <div id="global-names-wrapper" style="display: none; margin-bottom: 24px;">
                <div style="background: #f0fdf4; border: 1px solid #bbf7d0; border-radius: 8px; padding: 12px; margin-bottom: 12px;">
                    <span style="font-size: 13px; color: #166534; font-weight: 600;">
                        <i class="bi bi-info-circle"></i> Default Design Names: Any user-specific design field left empty below will use these names automatically.
                    </span>
                </div>
                        ...
                        block += `
                            <div class="dynamic-name-row">
                                ...
                                <input type="text" 
                                    ...
                                    data-pid="${pid}" 
                                    value="${savedVal}" 
                                    placeholder="Design name for this buyer" />
                            </div>
                        `;
                    });
                        ...
                        block += `
                            <div class="dynamic-name-row">
                                ...
                                <input type="text" 
                                    ...
                                    data-pid="${pid}" 
                                    value="${savedVal}" 
                                    placeholder="Design name for this craftsman" />
                            </div>
                        `;
                    });

...
<div class="container-fluid">
    <div class="row mb-3">
        <div class="col-12 d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('user.design.index') }}" class="btn btn-outline-secondary btn-sm">
            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-body bg-light rounded text-center">
                    ...
                    @if(count($allImages) > 0)
                        ...
                        @endphp
                        <img src="{{ $mainSrc }}" id="mainDisplay" class="img-fluid rounded shadow-sm mb-3" 
                        ...
                        @endif
                    @else
                        <div class="bg-white rounded d-flex align-items-center justify-content-center" style="height: 300px;">
            ...
            <div class="card border-0 shadow-sm h-100">
                ...
                <div class="card-body">
                    <div class="row g-4">
                        ...
                        <div class="col-md-8">
                            <label class="text-muted small d-block">Weight Range</label>

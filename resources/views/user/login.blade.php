...
<head>
    ...
    <title>ARIHANTH - User Login</title>
    ...
    <style>
        ...
        body {
            background: linear-gradient(135deg, #f4ece1 0%, #f4ece1 100%);
            min-height: 100vh;
            display: flex;
            align-items: center;
        ...
        .brand-logo-container {
            width: 80px;
            height: 80px;
            background-color: #FFD700; /* Yellow background like your logo style */
            padding: 8px;
            border-radius: 12px;
            margin-bottom: 15px;
            ...
            <div class="col-md-6 col-lg-5">
                <div class="login-card">
                    <div class="login-header">
                        ...
                        <p class="medium opacity-75 mb-0 uppercase tracking-widest">USER PORTAL</p>
                    </div>
                    ...
                    <div class="login-body">
                        ...
                        <form method="POST" action="{{ route('user.login') }}">
                            ...
                            <div class="mb-4">
                                <label for="login" class="form-label fw-bold">Email or User Code</label>
                            ...
                            <div class="mb-4">
                                <label for="password" class="form-label fw-bold d-flex justify-content-between">
                                    Password
                                    <a href="{{ route('user.password.request') }}" class="text-decoration-none" style="color: var(--brand-gold); font-size: 0.75rem;">Forgot Password?</a>
                                </label>
                                <div class="input-group">
                                    <span class="input-group-text">

                ...
                <div class="btn-toolbar mb-2 mb-md-0">
                    <div class="btn-group me-2">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{ route('super-admin.work-order.print', $workOrder) }}" target="_blank">Generate PDF</a></li>
                            <li><a class="dropdown-item" href="https://wa.me/?text=Work Order: {{ $workOrder->work_order_number }}">WhatsApp</a></li>
                        </ul>
                        <a href="{{ route('super-admin.work-order.index') }}" class="btn btn-secondary">Back to List</a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card shadow-sm mb-4">
                        ...
                        <div class="card-body">
                             <div class="row">
                                 ...
                                 <div class="col-md-6 mb-3"><label class="text-muted small d-block">Completed Date</label><div class="fw-bold">@if(strtolower($workOrder->status) === 'completed') <span class="text-success">{{ $workOrder->updated_at ? $workOrder->updated_at->format('d M, Y h:i A') : 'N/A' }}</span> @else <span class="text-muted">Not Completed</span> @endif</div></div><div class="col-md-6 mb-3"><label class="text-muted small d-block">Customer Name</label><p class="fw-bold">{{ $workOrder->customer_name }}</p></div>
                                 ...
                                 <div class="col-md-6 mb-3"><label class="text-muted small d-block">Category</label><p class="fw-bold">{{ $workOrder->productCategory->name ?? $workOrder->product_category ?? 'N/A' }}</p></div>
                                 <div class="col-md-6 mb-3"><label class="text-muted small d-block">Sub Category</label><p class="fw-bold">{{ $workOrder->subcategoryRelation->name ?? $workOrder->subcategory ?? 'N/A' }}</p></div>
                             </div>
                        </div>
                    </div>

                    <div class="card shadow-sm">
                        <div class="card-header bg-white"><h4>Physical Properties</h4></div>
                        <div class="card-body">
                            <div class="row">

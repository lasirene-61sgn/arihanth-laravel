                    ...
                    <form action="{{ route('super-admin.work-order.update', $workOrder) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                                        ...
                                        <div style="height: 100%; display: flex; align-items: center; justify-content: center; cursor: pointer; position: relative; width: 100%;" 
                                            ...
                                            @if($workOrder->file_type === 'pdf')
                                                <div class="pdf-thumbnail-container" style="height: 100%; overflow: hidden;">
                                                     <canvas class="pdf-canvas" data-url="{{ $workOrder->preview_image_url }}" style="height: 100%; width: 100%; object-fit: contain;"></canvas>
                                                </div>
                                            @else
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('bp_code') is-invalid @enderror" 
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-control @error('product_category_id') is-invalid @enderror" 
                                    ...
                                    @foreach($categories as $category)
                                        <option value="{{ $category->id }}" {{ (old('product_category_id', $workOrder->product_category_id) == $category->id || $workOrder->product_category == $category->name) ? 'selected' : '' }}>
                                            {{ $category->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="screw_name" class="form-label">Screw Name</label>
                                <select class="form-select @error('screw_name') is-invalid @enderror" id="screw_name" name="screw_name">
                            ...
                            <!-- <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('order_type') is-invalid @enderror" 
                                       id="order_type" name="order_type" value="{{ old('order_type', $workOrder->order_type) }}">
                                @error('order_type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div> -->
                            ...
                            <div class="col-md-6 mb-3">
                             ...
                             <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('hallmark') is-invalid @enderror" id="hallmark" name="hallmark">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('hook') is-invalid @enderror" id="hook" name="hook">
                                    <option value="">Select Option</option>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('rodium') is-invalid @enderror" id="rodium" name="rodium">
                                    <option value="">Select Option</option>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('enamel') is-invalid @enderror" id="enamel" name="enamel">
                                    <option value="">Select Option</option>
                            ...
                            <!-- <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('relabel_code') is-invalid @enderror" 
                                       id="relabel_code" name="relabel_code" value="{{ old('relabel_code', $workOrder->relabel_code) }}">
                                @error('relabel_code')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div> -->
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function fallbackNameMatch() {
            @if($workOrder->subcategory)
                const savedName = '{{ $workOrder->subcategory }}';
                const options = subcategorySelect.options;
                for (let i = 0; i < options.length; i++) {
                    if (options[i].text === savedName) {

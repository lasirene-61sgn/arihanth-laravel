...
<body>
    <div class="container">
        ...
        <div class="section">
            ...
            @endif
                ...
                <div class="detail-item">
                    ...
                    <div class="detail-value">{{ $workOrder->craftsman ? $workOrder->craftsman->business_name : $workOrder->allocated_craftsman_bp_code }}</div>
                </div>
                @endif
            </div>
        </div>
        ...
        @if($workOrder->narration_craftsman || $workOrder->narration_admin)
        <div class="section">
            <h2>Narrations</h2>
            @if($workOrder->narration_craftsman)
            <div class="detail-item">
                <div class="detail-label">Narration for Craftsman</div>
                <div class="narration detail-value">{{ $workOrder->narration_craftsman }}</div>
            </div>
            @endif
            
            @if($workOrder->narration_admin)
            <div class="detail-item">
                <div class="detail-label">Narration for Admin</div>
                <div class="narration detail-value">{{ $workOrder->narration_admin }}</div>
            </div>
            @endif
        </div>
        @endif

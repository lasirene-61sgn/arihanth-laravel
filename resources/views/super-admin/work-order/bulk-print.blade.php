...
<div class="wo-container {{ !$loop->last ? 'page-break' : '' }}">
        ...
        <div class="row">
            ...
            <div class="col-5">
                <div class="product-image-box">
                    ...
                    // Try to get local path for Base64 conversion (matches API logic for high clarity)
    ...
    <div class="wo-footer-stats">
        Arihanth Jewellers Pvt Ltd - Internal Production Document - Page
    </div>
</div>
@endforeach
        ...
        for (const canvas of canvases) {
            ...
            try {
                ...
                for (let pageNum = 1; pageNum <= pdf.numPages; pageNum++) {
                    ...
                    currentCanvas.style.width = '100%'; // CSS scales high-res canvas to container

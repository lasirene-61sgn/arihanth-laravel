...
@section('title', __('messages.edit_buyer'))
    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h1 class="h2">{{ __('messages.edit_buyer') }}</h1>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('super-admin.business-partner.buyer.update', $buyer) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                                            ...
                                            @foreach(\App\Models\Buyer::getWebPermissions() as $permission)
                                                <div class="col-md-6 mb-3">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="permissions[]" value="{{ $permission }}" id="permission_{{ $permission }}" {{ in_array($permission, old('permissions', $buyer->getPermissionsArray())) ? 'checked' : '' }}>
                        ...
                        <div class="mt-3">
                            <button type="submit" class="btn btn-primary">{{ __('messages.update_buyer') }}</button>

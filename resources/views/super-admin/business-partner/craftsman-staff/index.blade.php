...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="{{ route('super-admin.business-partner.craftsman-staff.create') }}" class="btn btn-primary">Add Staff</a>
    </div>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form method="GET" action="{{ route('super-admin.business-partner.craftsman-staff') }}" class="row g-3">
                ...
                <div class="col-md-4 d-flex align-items-end">
                    ...
                    <a href="{{ route('super-admin.business-partner.craftsman-staff') }}" class="btn btn-secondary">Reset</a>
                </div>
            </form>
        </div>
    </div>
        ...
        <table class="table table-bordered table-striped align-middle mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('super-admin.business-partner.craftsman-staff.edit', $staff->id) }}" class="btn btn-sm btn-warning">Edit</a>
                        <form action="{{ route('super-admin.business-partner.craftsman-staff.destroy', $staff->id) }}" method="POST" class="d-inline">
                            @csrf
                            @method('DELETE')

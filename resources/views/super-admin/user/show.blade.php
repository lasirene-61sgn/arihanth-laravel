        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a href="{{ route('super-admin.user.edit', $user) }}" class="btn btn-primary">Edit User</a>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row">
                    ...
                    <div class="d-flex justify-content-between mt-4">
                        <a href="{{ route('super-admin.user.index') }}" class="btn btn-secondary">Back to Users</a>
                        
                        <form action="{{ route('super-admin.user.destroy', $user) }}" method="POST" 

        ...
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('super-admin.user.update', $user) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                             ...
                             <div class="col-md-6 mb-3">
                                 ...
                                 <div class="custom-dropdown-container" id="dropdown_container_bp_code">
                                     ...
                                     <select class="form-control" id="bp_code" name="bp_code" required style="display: none;">
                                         ...
                                         @foreach($buyers as $buyer)
                                             <option value="{{ $buyer->bp_code }}" {{ (old('bp_code', $user->bp_code) == $buyer->bp_code) ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="email" class="form-control" id="email_id" name="email_id" value="{{ old('email_id', $user->email_id) }}" required>
                            </div>
                            
                            <div class="col-md-6 mb-3">
                                <label for="mobile_no" class="form-label">Mobile Number *</label>
                                <input type="text" class="form-control" id="mobile_no" name="mobile_no" value="{{ old('mobile_no', $user->mobile_no) }}" required>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="aadhar_number" name="aadhar_number" value="{{ old('aadhar_number', $user->aadhar_number) }}">
                            </div>
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="{{ route('super-admin.user.index') }}" class="btn btn-secondary">Cancel</a>

...
<head>
    <meta charset="UTF-8">
    <title>User Profile - Arihanth Jewellers</title>
</head>
    ...
    <div style="max-width: 850px; margin: 0 auto 40px auto; border: 1px solid #e2e8f0; border-radius: 8px; overflow: hidden; background: #ffffff; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.05);">
        ...
        <div style="padding: 25px; border-bottom: 1px solid #f1f5f9; display: flex; justify-content: space-between; align-items: center; background-color: #f8fafc;">
            ...
            <div style="text-align: right;">
                <span style="font-size: 11px; color: #94a3b8; text-transform: uppercase; font-weight: bold; letter-spacing: 1px;">User Access Report</span><br>
        ...
        <div style="padding: 30px;">
            ...
            <table style="width: 100%; border-collapse: collapse;">
                ...
                <tr>
                    ...
                    <td style="padding: 12px 0; border-bottom: 1px solid #f1f5f9; color: #0f172a; font-size: 13px; font-weight: 600;">{{ $user->full_name }}</td>
                </tr>
                @endif
                ...
                <tr>
                    ...
                    <td style="padding: 12px 0; border-bottom: 1px solid #f1f5f9; color: #0f172a; font-size: 13px;">{{ $user->email_id }}</td>
                </tr>
                @endif
                ...
                <tr>
                    ...
                    <td style="padding: 12px 0; border-bottom: 1px solid #f1f5f9; color: #0f172a; font-size: 13px;">{{ $user->mobile_no }}</td>
                </tr>
                @endif
                ...
                <tr>
                    ...
                    <td style="padding: 12px 0; border-bottom: 1px solid #f1f5f9; color: #0f172a; font-size: 13px;">{{ $user->city }}</td>
                </tr>
                @endif

                @if($user->buyer)
                <tr>
                    <td style="padding: 12px 0; border-bottom: 1px solid #f1f5f9; color: #64748b; font-size: 13px;">Business Partner</td>
                    <td style="padding: 12px 0; border-bottom: 1px solid #f1f5f9; color: #0f172a; font-size: 13px;">
                        <strong>{{ $user->buyer->bp_code }}</strong> - {{ $user->buyer->business_name }}
                    </td>
                </tr>
                @endif
                ...
                <tr>
                    ...
                    <td style="padding: 12px 0; border-bottom: 1px solid #f1f5f9; color: #0f172a; font-size: 13px;">
                        <span style="background: #f1f5f9; padding: 2px 8px; border-radius: 4px; font-weight: 600;">{{ ucfirst($user->status) }}</span>
                    </td>
                </tr>
                @endif
        ...
        <div style="background: #f8fafc; padding: 15px 25px; text-align: center; font-size: 10px; color: #cbd5e1; text-transform: uppercase; letter-spacing: 2px;">
            Arihanth Jewellers Pvt Ltd - Internal ERP System Record
        </div>
    </div>

    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                ...
                <a href="{{ route('super-admin.repairs.index') }}" class="btn btn-sm btn-secondary">
            ...
            <div class="card mt-3">
                <div class="card-body">
                    <form action="{{ route('super-admin.repairs.update', $repair->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input class="form-control" list="receivedByDatalist" id="item_received_by" name="item_received_by" value="{{ old('item_received_by', $repair->item_received_by) }}" placeholder="Type or select...">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="mt-2">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="item_delivered_by_type" id="delivered_type_self" value="Self" {{ old('item_delivered_by_type', $repair->item_delivered_by_type) == 'Self' ? 'checked' : '' }}>
                                        <label class="form-check-label" for="delivered_type_self">Self (BP Code)</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="item_delivered_by_type" id="delivered_type_ajpl" value="AJPL" {{ old('item_delivered_by_type', $repair->item_delivered_by_type) == 'AJPL' ? 'checked' : '' }}>

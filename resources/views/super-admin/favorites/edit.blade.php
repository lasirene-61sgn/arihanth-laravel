...
<div>
    ...
    <div class="card">
        ...
        <form action="{{ route('super-admin.favorites.update', [$user->id, $user_type]) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <!-- Custom Design Names for this User -->
            <div id="dynamic-names-wrapper" style="margin-bottom: 24px;">
                ...
                <div id="dynamic-names-container">
                    <!-- Populated by JS -->
                </div>
            </div>
...
<script>
    $(document).ready(function() {
        // Pre-fill existing design names from database
        ...
        function renderRows() {
            ...
            // Capture current user-typed values before re-rendering
            let currentValues = {};
            ...
            if (selectedData.length > 0) {
                ...
                selectedData.forEach(function(item) {
                    ...
                    // Check user input first, then database value

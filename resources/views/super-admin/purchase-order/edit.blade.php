        ...
        <div class="col-12">
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('super-admin.purchase-order.update', $purchaseOrder) }}" enctype="multipart/form-data" id="purchaseOrderForm">
                        @csrf
                        @method('PUT')
                                            ...
                                            @foreach($itemsWithDetails as $index => $item)
                                                <tr class="item-row">
                                                    ...
                                                    <td>
                                                        ...
                                                        @else
                                                            <div class="saved-preview mb-2" style="display:none;">
                                                                <small class="text-primary d-block fw-bold">Current Order Image:</small>
                        ...
                        <div class="d-flex justify-content-between border-top pt-3">
                            <a href="{{ request('return_url', route('super-admin.purchase-order.index')) }}" class="btn btn-secondary px-4">Cancel</a>

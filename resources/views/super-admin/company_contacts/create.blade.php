...
@section('title', __('messages.add_contact_detail'))
    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h1 class="h2">{{ __('messages.add_contact_detail') }}</h1>
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('super-admin.company-contacts.store') }}" method="POST">
                        @csrf
                        <div class="row mb-3">
                            <div class="col-md-6">
                        ...
                        <div id="simple-field" class="row mb-3">
                            <div class="col-12">
                                <label for="value" id="value-label" class="form-label">Value *</label>

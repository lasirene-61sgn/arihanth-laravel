...
<div class="space-y-6">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
            ...
            <p class="text-sm text-slate-500">Add a new item to your business catalog.</p>
        </div>
    ...
    <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
        ...
        <div class="p-6 md:p-8">
            ...
            <form action="{{ route('buyer.product.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" 
                               ...
                               id="bp_code" 
                               name="bp_code" 
                               value="{{ isset($buyer) ? $buyer->bp_code : old('bp_code') }}" 
                               readonly>
                        @if(isset($buyer))
                            <p class="text-[11px] font-medium text-slate-500 italic"><i class="bi bi-building mr-1"></i> Business: {{ $buyer->business_name }}</p>
                        @endif
                    ...
                    <div class="space-y-2 category-option" data-opt="has_hook" style="display:none;">
                        ...
                        <input type="text" class="w-full px-4 py-2.5 bg-white border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-blue-500 outline-none" id="hook" name="hook" value="{{ old('hook') }}">
                    </div>
                    ...
                    <div class="space-y-2 category-option" data-opt="has_enamel" style="display:none;">
                        ...
                        <input type="text" class="w-full px-4 py-2.5 bg-white border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-blue-500 outline-none" id="enamel" name="enamel" value="{{ old('enamel') }}">
                    </div>
                    ...
                    <div class="space-y-2 category-option" data-opt="has_rodium" style="display:none;">
                        ...
                        <input type="text" class="w-full px-4 py-2.5 bg-white border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-blue-500 outline-none" id="rodium" name="rodium" value="{{ old('rodium') }}">
                    </div>
                    ...
                    <div class="space-y-2 category-option" data-opt="has_stone" style="display:none;">
                        ...
                        <input type="text" class="w-full px-4 py-2.5 bg-white border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-blue-500 outline-none" id="stone" name="stone" value="{{ old('stone') }}">
                    </div>
                    ...
                    <div class="md:col-span-2 space-y-2">
                        <label for="images" class="text-sm font-bold text-slate-700">Product Images (Only white background, *No Logo, No Title .)</label>

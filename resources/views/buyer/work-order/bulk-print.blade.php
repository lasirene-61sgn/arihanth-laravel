...
<head>
    ...
    <title>Bulk Work Orders Report</title>
                    ...
                    <div class="flex gap-10 items-start">
                        <div class="flex-1">
                            ...
                            <div class="grid grid-cols-2 gap-x-6 gap-y-5">
                                ...
                                <div>
                                    <p class="text-[10px] font-bold text-slate-400 uppercase">BP / weight </p>
                                    <p class="text-sm font-bold text-slate-800">{{ $workOrder->bp_code }} / {{ $workOrder->weight_from ?? 'N/A' }}g</p>
                                </div>
                            </div>

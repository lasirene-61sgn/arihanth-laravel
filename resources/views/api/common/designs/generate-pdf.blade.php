...
<body>
    <div class="header">
        <div class="logo">
            ...
            @else
            <h2 style="margin:0; color:#337ab7;">LASIRENE</h2>
            @endif
        </div>
    ...
    <div class="product-card">
        ...
        <div class="product-details">
            <div style="font-size: 14pt; font-weight: bold; color: #337ab7; margin-bottom: 10px;">{{ $product->product_name }}</div>
            <table class="table">
                <tbody>
                    {{-- Design Code --}}
                    ...
                    {{-- Status --}}
                    @if(!empty($product->design_status))
                    <tr>
                        <td class="label">Status</td>
                        <td class="value">
                            @php
                            $status = strtolower($product->design_status);
                            $statusClass = 'status-' . $status;
                            @endphp
                            <span class="status-badge {{ $statusClass }}">{{ ucfirst($product->design_status) }}</span>
                        </td>
                    </tr>
                    @endif
                    ...
                    <tr>
                        ...
                        <td class="value" style="font-size: 9pt;">{{ $product->description }}</td>
                    </tr>
                    @endif
                </tbody>
            </table>

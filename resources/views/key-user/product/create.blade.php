                ...
                <div class="bg-slate-50 rounded-3xl p-6 border border-slate-100">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" step="0.001" class="w-full px-4 py-2.5 bg-white border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-blue-500 outline-none" id="weight_from" name="weight_from" value="{{ old('weight_from') }}">
                        </div>
                        <div class="space-y-2">
                            <label for="weight_to" class="text-sm font-bold text-slate-700">Weight To (gm)</label>
                            <input type="text" step="0.001" class="w-full px-4 py-2.5 bg-white border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-blue-500 outline-none" id="weight_to" name="weight_to" value="{{ old('weight_to') }}">
                        </div>
                    </div>
                </div>

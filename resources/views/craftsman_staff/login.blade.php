...
<head>
    ...
    <title>Craftsman Staff Login | ARIHANTH JEWELLERS</title>
...
<body class="h-full flex items-center justify-center p-6 bg-[#f8fafc]">
    ...
    <div class="max-w-md w-full">
        <div class="text-center mb-8 flex flex-col items-center">
            ...
            <p class="text-gray-400 text-[14px] font-bold uppercase tracking-[0.2em] mt-3 italic">Staff Portal</p>
        </div>

        <div class="bg-white rounded-[2.5rem] shadow-2xl shadow-gray-200 border border-gray-100 overflow-hidden">
            <div class="p-8 md:p-10">
                <div class="mb-8">
                    <h2 class="text-2xl font-black text-gray-800 tracking-tight">Staff Sign In</h2>
                    <p class="text-gray-400 text-sm mt-1">Enter your staff code to access the portal</p>
                </div>
                ...
                <form method="POST" action="{{ route('craftsman_staff.login') }}" class="space-y-6">
                    @csrf
                    
                    <div>
                        <label for="staff_code" class="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2 ml-1">
                            Staff Code *
                        </label>
                        <div class="relative group">
                            ...
                            <input type="text" 
                                   ...
                                   required 
                                   placeholder="Enter Code (e.g. CS0001)"

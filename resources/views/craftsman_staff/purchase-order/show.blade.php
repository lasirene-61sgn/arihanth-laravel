    ...
    <div class="row">
        <div class="col-12">
                ...
                <div class="btn-toolbar mb-2 mb-md-0">
                    <div class="btn-group me-2">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a class="dropdown-item" href="{{ route('craftsman_staff.purchase-order.print', $purchaseOrder) }}" target="_blank">
                        ...
                        <a href="{{ route('craftsman_staff.purchase-order.index') }}" class="btn btn-secondary">
            ...
            <div class="card mt-4 shadow-sm">
                ...
                <div class="card-body">
                    @if($itemsWithDetails && count($itemsWithDetails) > 0)
                        <form method="POST" action="{{ route('craftsman_staff.purchase-order.process-items', $purchaseOrder) }}">
                            @csrf
                            @method('PUT')
                                            ...
                                            <tr>
                                                @if($purchaseOrder->craftsman_status == 'in_process')
                                                    <td class="text-center">
                                                        <input type="checkbox" name="selected_items[]" value="{{ $index }}" class="item-checkbox w-4 h-4 text-indigo-600 rounded" form="bulkCompleteItemsForm">
                                                    </td>
                                                @endif
                                                <td>{{ $index + 1 }}</td>
                                                <td class="text-center">
                                                ...
                                                @if($purchaseOrder->craftsman_status == 'in_process')
                                                    <td class="text-center">
                                                        <form method="POST" action="{{ route('craftsman_staff.purchase-order.complete-items', $purchaseOrder) }}">
                                                            @csrf
                            ...
                            @if($purchaseOrder->craftsman_status == 'in_process' && count($itemsWithDetails) > 0)
                                <div class="mt-3 d-flex justify-content-end">
                                    <form id="bulkCompleteItemsForm" method="POST" action="{{ route('craftsman_staff.purchase-order.complete-items', $purchaseOrder) }}">
                                        @csrf
            ...
            <div class="d-flex justify-content-between mt-4 mb-5">
                <a href="{{ route('craftsman_staff.purchase-order.index') }}" class="btn btn-secondary">Back</a>
                
                @if($purchaseOrder->craftsman_status == 'in_process')
                    <form method="POST" action="{{ route('craftsman_staff.purchase-order.complete', $purchaseOrder) }}">
                        @csrf

                ...
                <div class="d-flex flex-wrap align-items-center gap-2">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow border-0">
                            <li>
                                <a class="dropdown-item d-flex align-items-center gap-2 py-2" href="{{ route('craftsman_staff.work-order.print', $workOrder) }}" target="_blank">
                                    <i class="bi bi-file-earmark-pdf text-danger fs-5"></i>
                                    <span>Generate PDF/Image</span>
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item d-flex align-items-center gap-2 py-2" href="#" onclick="window.open('{{ route('craftsman_staff.work-order.print', $workOrder) }}', '_blank', 'width=800,height=600'); return false;">
                    ...
                    <a href="{{ route('craftsman_staff.work-order.index') }}" class="btn btn-light border d-inline-flex align-items-center gap-2 px-3 shadow-sm">
                ...
                <div class="card-body p-4">
                    @if($workOrder->craftsman_status == 'allocated')
                        <div class="d-flex flex-wrap gap-2">
                            <form action="{{ route('craftsman_staff.work-order.accept', $workOrder) }}" method="POST" class="d-inline">
                                @csrf
                            ...
                            <form action="{{ route('craftsman_staff.work-order.reject', $workOrder) }}" method="POST" class="d-inline">
                                @csrf
                    ...
                    @elseif($workOrder->craftsman_status == 'completed')
                        <button type="button" onclick="showSingleCompleteModal('{{ route('craftsman_staff.work-order.complete', $workOrder) }}')" class="btn btn-primary d-inline-flex align-items-center gap-2 px-4 shadow-sm">

...
<div class="space-y-6">
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-indigo-200 pb-4">
        <h1 class="text-2xl font-bold text-indigo-900">Craftsman Dashboard</h1>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
        <div class="bg-white p-6 rounded-xl shadow-sm border border-indigo-100 hover:shadow-md transition">
            <div class="flex items-center justify-center w-12 h-12 bg-indigo-100 text-indigo-700 rounded-lg mb-4">
                <i class="bi bi-clipboard-data text-xl"></i>
            </div>
            <div class="text-2xl font-bold text-indigo-900">{{ $woStats['total'] }}</div>
            <div class="text-sm font-medium text-indigo-600">Work Orders</div>
        ...
        <div class="bg-white p-6 rounded-xl shadow-sm border border-indigo-100 hover:shadow-md transition">
            ...
            <div class="text-2xl font-bold text-indigo-900">{{ $poStats['total'] }}</div>
            <div class="text-sm font-medium text-indigo-600">Purchase Orders</div>
            <div class="flex flex-wrap gap-1 mt-3">
                <span class="px-1.5 py-0.5 rounded text-[9px] font-bold bg-slate-100 text-slate-600 border border-slate-200">
        ...
        <div class="bg-white p-6 rounded-xl shadow-sm border border-indigo-100 hover:shadow-md transition">
            ...
            <div class="text-2xl font-bold text-indigo-900">{{ $totalProducts }}</div>
            <div class="text-sm font-medium text-indigo-600">My Products</div>
        </div>
        ...
        <div class="bg-white p-6 rounded-xl shadow-sm border border-amber-100 hover:shadow-md transition tw-cursor-pointer" data-bs-toggle="modal" data-bs-target="#progressAnalyticsModal">
            ...
            <div class="text-sm font-bold text-indigo-900 mb-2">Progress Analytics</div>
            <div class="space-y-1">
                <div class="flex justify-between text-[10px] uppercase tracking-wider">
                    <span class="text-indigo-600 font-bold">Allocated:</span>
                    <span class="font-black text-indigo-900">{{ number_format($woStats['allocated_weight'] + $poStats['allocated_weight'], 2) }}g</span>
                </div>
                <div class="flex justify-between text-[10px] uppercase tracking-wider">
                    <span class="text-indigo-600 font-bold">In Process:</span>
                    <span class="font-black text-blue-600">{{ number_format($woStats['in_process_weight'] + $poStats['in_process_weight'], 2) }}g</span>
                </div>
                <div class="flex justify-between text-[10px] uppercase tracking-wider">
                    <span class="text-indigo-600 font-bold">Overdue:</span>
        ...
        <div class="bg-white p-6 rounded-xl shadow-sm border border-indigo-100 hover:shadow-md transition">
            <div class="flex items-center justify-center w-12 h-12 bg-indigo-800 text-white rounded-lg mb-4">
                <i class="bi bi-journal-text text-xl"></i>
            </div>
            <div class="text-2xl font-bold text-indigo-900">{{ $totalDesigns }}</div>
            <div class="text-sm font-medium text-indigo-600">My Catalogue</div>
        </div>
    </div>
    ...
    <!-- <div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
            <div class="bg-white p-4 rounded-xl shadow-sm border border-indigo-100">
                <div class="text-sm font-medium text-indigo-600 mb-1">Total</div>
                <div class="text-2xl font-bold text-indigo-900">{{ $woStats['total'] }}</div>
            </div>
            <div class="bg-white p-4 rounded-xl shadow-sm border border-indigo-100">
                <div class="text-sm font-medium text-indigo-600 mb-1">Allocated</div>
                <div class="text-2xl font-bold text-indigo-700">{{ $woStats['allocated'] }}</div>
            </div>
            <div class="bg-white p-4 rounded-xl shadow-sm border border-indigo-100">
                <div class="text-sm font-medium text-indigo-600 mb-1">In Process</div>
                <div class="text-2xl font-bold text-amber-600">{{ $woStats['in_process'] }}</div>
            </div>
            <div class="bg-white p-4 rounded-xl shadow-sm border border-indigo-100">
                <div class="text-sm font-medium text-indigo-600 mb-1">Completed</div>
                <div class="text-2xl font-bold text-green-600">{{ $woStats['completed'] }}</div>
            </div>
            <div class="bg-white p-4 rounded-xl shadow-sm border border-indigo-100">
                <div class="text-sm font-medium text-indigo-600 mb-1">For Approval</div>
                <div class="text-2xl font-bold text-teal-600">{{ $woStats['for_approval'] }}</div>
            </div>
            <div class="bg-white p-4 rounded-xl shadow-sm border border-indigo-100">
                <div class="text-sm font-medium text-indigo-600 mb-1">Rejected</div>
                <div class="text-2xl font-bold text-red-600">{{ $woStats['rejected'] }}</div>
            </div>
            <div class="bg-white p-4 rounded-xl shadow-sm border border-indigo-100">
                <div class="text-sm font-medium text-indigo-600 mb-1">Overdue</div>
    ...
    <!-- <div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
            ...
            <div class="bg-white p-4 rounded-xl shadow-sm border border-indigo-100">
                <div class="text-sm font-medium text-indigo-600 mb-1">Allocated</div>
                <div class="text-2xl font-bold text-indigo-700">{{ $poStats['allocated'] }}</div>
            </div>
            <div class="bg-white p-4 rounded-xl shadow-sm border border-indigo-100">
                <div class="text-sm font-medium text-indigo-600 mb-1">In Process</div>
    ...
    <!-- <div class="bg-white rounded-xl shadow-sm border border-indigo-100 overflow-hidden">
        <div class="bg-indigo-50 px-6 py-4 border-b border-indigo-100">
            <h4 class="text-lg font-bold text-indigo-900 mb-0">Welcome, {{ $craftsman->business_name }}</h4>
        </div>
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-2">
                <div class="space-y-3">
                    <div class="flex justify-between border-b border-indigo-50 py-2">
                        <span class="text-indigo-600 font-medium">Craftsman Code</span>
                        <span class="text-indigo-900 font-bold">{{ $craftsman->craftman_code }}</span>
                    </div>
                    <div class="flex justify-between border-b border-indigo-50 py-2">
                        <span class="text-indigo-600 font-medium">Email</span>
                        <span class="text-indigo-900">{{ $craftsman->email }}</span>
                    </div>
                    <div class="flex justify-between border-b border-indigo-50 py-2">
                        <span class="text-indigo-600 font-medium">Mobile</span>
                        <span class="text-indigo-900">{{ $craftsman->mobile }}</span>
                    </div>
                    <div class="flex justify-between border-b border-indigo-50 py-2">
                        <span class="text-indigo-600 font-medium">Business Type</span>
                        <span class="text-indigo-900">{{ $craftsman->business_type }}</span>
                    </div>
                </div>
                <div class="space-y-3">
                    <div class="flex justify-between border-b border-indigo-50 py-2">
                        <span class="text-indigo-600 font-medium">City</span>
                        <span class="text-indigo-900">{{ $craftsman->city }}</span>
                    </div>
                    <div class="flex justify-between border-b border-indigo-50 py-2">
                        <span class="text-indigo-600 font-medium">State</span>
                        <span class="text-indigo-900">{{ $craftsman->state }}</span>
                    </div>
                    <div class="flex justify-between border-b border-indigo-50 py-2">
                        <span class="text-indigo-600 font-medium">Address</span>
                        <span class="text-indigo-900 text-right">{{ $craftsman->address }}</span>
                    </div>
                    <div class="flex justify-between border-b border-indigo-50 py-2">
                        <span class="text-indigo-600 font-medium">Status</span>
                        @if($craftsman->status == 'active')
                            <span class="px-2 py-1 text-xs font-bold bg-indigo-100 text-indigo-700 rounded">Active</span>
                        @else
    ...
    <div class="bg-white rounded-xl shadow-sm border border-indigo-100 overflow-hidden">
        <div class="px-6 py-4 border-b border-indigo-100 flex items-center justify-between">
            <h4 class="text-lg font-bold text-indigo-900">Allocated Work Orders</h4>
            <span class="bg-indigo-600 text-white text-xs font-bold px-3 py-1 rounded-full">{{ $workOrders->count() }}</span>
        </div>
        <div class="p-0 overflow-x-auto">
            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-indigo-50">
                    ...
                    <tr class="hover:bg-indigo-50/50 transition">
                        <td class="px-6 py-4 font-bold text-indigo-900">{{ $order->work_order_number }}</td>
                        <!-- <td class="px-6 py-4 text-indigo-800">{{ $order->customer_name }}</td> -->
                        <td class="px-6 py-4 text-indigo-800">{{ $order->product_name }}</td>
                        <td class="px-6 py-4 text-center font-semibold text-indigo-900">{{ $order->quantity }}</td>
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4 text-center">
                            <a href="{{ route('craftsman_staff.work-order.show', $order) }}"
                                class="inline-flex items-center justify-center w-8 h-8 rounded-lg bg-indigo-50 text-indigo-700 hover:bg-indigo-600 hover:text-white transition">
                                <i class="bi bi-eye"></i>
                            </a>
                        </td>
                    </tr>
            ...
            <div class="text-center py-12">
                <div class="w-16 h-16 bg-indigo-50 rounded-full flex items-center justify-center mx-auto mb-4">
                    <i class="bi bi-clipboard text-indigo-200 text-3xl"></i>
                </div>
                <h5 class="text-indigo-900 font-bold text-lg">No work orders assigned</h5>
                <p class="text-indigo-500">When orders are allocated to you, they will appear here.</p>
            </div>
            @endif
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-indigo-100 overflow-hidden">
        <div class="px-6 py-4 border-b border-indigo-100">
            <h4 class="text-lg font-bold text-indigo-900 mb-0">Quick Action Links</h4>
        </div>
        <div class="p-6">
            <div class="flex flex-wrap gap-3">
                <a href="{{ route('craftsman_staff.work-order.index') }}"
                    class="inline-flex items-center px-4 py-2 bg-indigo-900 text-white rounded-lg text-sm font-semibold hover:bg-indigo-800 transition shadow-sm">
                    <i class="bi bi-list-task me-2"></i> View All Work Orders
                </a>
                <a href="{{ route('craftsman_staff.product.index') }}"
                    class="inline-flex items-center px-4 py-2 bg-indigo-600 text-white rounded-lg text-sm font-semibold hover:bg-indigo-500 transition shadow-sm">
    ...
    <div class="modal fade" id="progressAnalyticsModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content rounded-2xl border-0 shadow-2xl overflow-hidden">
                <div class="modal-header border-0 bg-indigo-50 px-8 py-6">
                    <div class="flex items-center gap-3">
                        <div class="w-10 h-10 rounded-xl bg-indigo-100 text-indigo-600 flex items-center justify-center">
                            <i class="bi bi-graph-up-arrow text-xl"></i>
                        </div>
                        <div>
                            <h5 class="modal-title font-bold text-indigo-900">My Progress Analytics (WA & PA)</h5>
                            <p class="text-indigo-600 text-xs mb-0">Personal production summary</p>
                        </div>
                    </div>
                ...
                <div class="modal-body p-0">
                    <div class="table-responsive">
                        <table class="table table-bordered mb-0 align-middle">
                            <thead>
                                <tr class="bg-indigo-50 text-[11px] font-bold uppercase tracking-wider text-indigo-700">

    ...
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
        <div>
            <div class="d-flex align-items-center gap-2 mb-1">
                <a href="{{ route('craftsman_staff.repairs.index') }}" class="text-decoration-none text-muted small fw-medium">
        ...
        <div>
            <a href="{{ route('craftsman_staff.repairs.index') }}" class="btn btn-white btn-sm border shadow-sm px-3 fw-medium">
